...
class LITS_preprocess:
    ...
    def process(self, ct_path, seg_path, classes=None):
        ...
        start_slice, end_slice = np.where(z)[0][[0, -1]]            #  np.where(z): tuple:1 [332,333,334...] 第0个索引就是一个ndarray   # np.where(z)[0]: ndarray:(179,)   #  332 510
    ...
    def write_train_val_name_list(self):
        ...
        train_name_list = data_name_list[0:int(data_num*(1-self.valid_rate))]           # 将名字 划分为训练集和验证集
...
if __name__ == '__main__':
    raw_dataset_path = '/home/lab321/D/yf/3DUNet-Pytorch/raw_dataset/train'
    fixed_dataset_path = '/home/lab321/D/yf/3DUNet-Pytorch/fixed_data'
