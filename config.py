...
parser.add_argument('--dataset_path',default = '/home/lab321/D/yf/3DUNet-Pytorch/fixed_data',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = '/ssd/lzq/dataset/LiTS/test',help='Testset path')
# parser.add_argument('--dataset_path',default='/home/lab321/D/yf/3DUNet-Pytorch/raw_dataset/train',help='fixed trainset root path')
# parser.add_argument('--test_data_path',default='/home/lab321/D/yf/3DUNet-Pytorch/raw_dataset/test',help='Testset path')
